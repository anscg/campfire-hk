// Hong Kong Campfire Event Configuration
export const hongkongConfig = {
  ...
  localization: {
    en: {
      ...
      steps: {
        step1: "Sign up for **Campfire** Hong Kong",
        step2:
      ...
      letter: {
        ...
        paragraph1:
          "Welcome to Hack Club's newest adventure. This winter we invite you to join us for Campfire, a Game Jam happening in Hong Kong!",
    ...
    zh: {
      ...
      steps: {
        step1: "報名參加香港 **Campfire**<br />活動",
        step2: "與 **朋友** 組隊（或結識新朋友！）__組成__ **2-3人團隊**",
        step3: "參加 **工作坊** 學習，享受 __免費食物和紀念品！__",
        step4: "**製作** 你的遊戲並在 itch.io **發佈**！",
        guideButton: "閱讀更多",
      },
      letter: {
        greeting: "親愛的駭客、音樂家和藝術家們，",
        paragraph1:
          "歡迎來到 Hack Club 的最新冒險。今個冬天，我們邀請你參加 Campfire 活動，一個在香港舉行的遊戲開發活動！",
        paragraph2: "Hack Club 希望你在這個冬天製作一個遊戲。",
        paragraph3:
          "不認為自己是遊戲開發者？沒問題！我們有大量線上和面對面的工作坊，幫助你製作第一個遊戲！",
        paragraph4:
          "今個冬天，我們邀請你學習新事物，創作令自己自豪的作品，結識新朋友，一起展開一場精彩的冒險。",
        closing: "此致",
        signature: "Campfire 香港團隊",
      },
      footer: {
        tagline: "由 Hack Club 與 Open Sauce 用心製作",
        copyright: "© 2026 Hack Club. 501(c)(3) 非牟利組織 (EIN: 81-2908499)",
        description:
          "Hack Club 是一個 501(c)(3) 非牟利組織，連結超過 60,000 名中學生。我們相信通過實踐學習效果最好，因此我們建立社群並提供資助，讓你製作出色的專案。過去幾年，我們與 GitHub 合作舉辦了 ",
        closing: "在 Hack Club，學生不僅在學習，更在創造。",
        links: [
          { text: "Hack Club", href: "https://hackclub.com/" },
          { text: "Slack", href: "https://hackclub.com/slack" },
          { text: "Clubs", href: "https://hackclub.com/clubs" },
          { text: "行為準則", href: "https://hackclub.com/conduct/" },
        ],
      },
    },
  },
    ...
    faq: {
      ...
      en: {
        participant: {
          ...
          buttonHref:
            "https://docs.google.com/document/d/1Iaj3re3NULerjCcAIXC4G-Ishd1TmP9Ojw2xH8l58ik/edit?tab=t.0#heading=h.12mg8uzylly",
        },
      },
      zh: {
        participant: {
          ...
          questions: [
            {
              question: "什麼是遊戲開發活動？",
              answer:
                "遊戲開發活動是一個在短時間內從零開始製作遊戲的活動！這是關於創意、團隊合作，以及在學習新技能的同時享受樂趣。",
            },
            {
              question: "我符合資格嗎？",
              answer:
                "如果你是中學生（或更年輕），你就符合資格！無需任何經驗 - 只需帶來你的熱情和學習意願。",
            },
            {
              question: "但我從未參加過這類活動！",
              answer:
                "很好！遊戲開發活動專為初學者設計。你將有工作坊、導師和隊友在每一步幫助你。",
            },
            {
              question: "這一切都是免費的？",
              answer:
                "是的！一切都是完全免費的 - 場地、食物、紀念品、工作坊和獎品。Hack Club 承擔所有費用，讓你專注於創作。",
            },
            {
              question: "我需要帶什麼？",
              answer:
                "只需帶上你自己、一台筆記本電腦、充電器和任何你需要的個人物品。我們會提供食物、飲料和其他一切！",
            },
          ],
          buttonText: "查看家長指南",
          buttonHref:
...
export type HongKongConfig = typeof hongkongConfig;
